<div class="modal fade" id="modal_editar_docente" tabindex="-1" role="dialog" aria-hidden="true">
  <form class="modal-dialog modal-dialog-centered" role="document" action="{{route('docentes.update',$docente)}}" autocomplete="off" method="POST">
    @csrf
