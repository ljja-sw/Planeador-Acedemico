                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea rows="10" name="descripcion" id="editor" class="form-control"
                                              placeholder="Ingrese el contenido completo del reporte"></textarea>
                                </div>
                            </div>
                            ...
                            <div id="pruden">
                                <div class="form-group card-body" id='acta' style=" display:none" ;>
                                    <div class="mb-3">
                                        <label>Motivo</label>
                                        <textarea rows="5" name="justificacion" id="#"
                                                  class="form-control medium-textarea"
                                                  placeholder="Ingrese el contenido completo del reporte"></textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Temas</label>
                                <select name="tema_planeador" class=" form-control" id="temas_planeador_select"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <a href="#pruden" class="btn btn-elegant btn-block"
                                   onclick="var ch=document.getElementById('acta');ch.style.display='inline' ; ">
